    ...
    Surface (
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = "Konganthanparai, Tamil Nadu,\nIndia - 627007",
...
//Treasurer
            ...
            Text(
                text = "R. ரிச்சர்ட் ஜேம்ஸ் பீட்டர்.",
                modifier = Modifier.padding(horizontal = 15.dp),
                fontSize = 16.sp,
                fontFamily = FontFamily(Font(R.font.roboto)),
                fontWeight = FontWeight.Normal,
...
//Official members
            Text(
                text = "Official Members of Pastorate:",
                modifier = Modifier.padding(horizontal = 15.dp),
                fontSize = 16.sp,
                fontFamily = FontFamily(Font(R.font.roboto)),
                fontWeight = FontWeight.SemiBold,
